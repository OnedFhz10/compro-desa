...
@section('content')
    ...
    <x-hero 
        title="APBDes" 
        subtitle="Transparansi Anggaran"
    ...
    <div class="bg-gray-50 border-b border-gray-200">
        <div class="container mx-auto px-4 lg:px-8 py-3">
            <nav class="flex text-sm text-gray-600">
                ...
                <span class="mx-2">/</span>
                <span class="text-gray-900 font-medium">APBDes</span>
            </nav>
        </div>
    </div>
                            ...
                            @forelse($data as $key => $item)
                                <tr class="hover:bg-slate-50/50 transition duration-150">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-xs text-blue-600 font-bold uppercase mt-1">APBDes {{ $item->year }}</div>
                                    </td>
